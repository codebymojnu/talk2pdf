  ...
  return (
    <>
      ...
      >
        ...
        <p
          className="mt-5 max-w-prose text-zinc-700 sm:text-xl"
        >
          Talk2PDF allows you to have conversation with any PDF document. Simply upload your file and start asking questions right away.
        </p>
