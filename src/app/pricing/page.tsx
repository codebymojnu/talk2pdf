...
const Page =async () => {
    ...
    return ( 
         <>
            <MaxWidthWrapper
                className="mb-8 mt-24 text-center max-w-5xl"
            >
                <div className="mx-auto mb-10 sm:max-w-lg">
                    <h1 className="text-6xl font-bold sm:text-7xl">Pricing</h1>
                    <p className="mt-5 text-gray-600 sm:text-lg">
                        Whether you&apos;re just trying out our service or need more we&apos; got you covered.
                    </p>
                </div>
                                        ...
                                        <div className="flex items-center space-x-1">
                                            ...
                                            <Tooltip delayDuration={300}>
                                                ...
                                                <TooltipContent className="w-80 p-2">
                                                    The number of PDFs you can upload per month depending upon your plan.
                                                </TooltipContent>
                                            </Tooltip>
                                        </div>
                                    </div>
